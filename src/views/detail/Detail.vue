<template>
  <div id="detail">
    ...
    <scroll class="content" ref="scroll" :probe-type='3' @scroll="contentScroll">
      ...
      <detail-goods-info :detail-info='detailInfo' @imgLoad='imgLoad' class="goods-info"
                         ref="goodsInfo"></detail-goods-info>
...
<script>
  ...
  import {getDetail, Goods, GoodsParam, getRecommend, Shop} from 'network/detail';
